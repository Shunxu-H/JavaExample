...
public class ST {
    ...
    // each sentence has a TK object

    public static final ST REF_ID  = new ST("ST.REF_ID"); // REF_ID
    public static final ST FACTOR  = new ST("ST.FACTOR"); // FACTOR
    public static final ST TERM    = new ST("ST.TERM"); // TEAM
    public static final ST EXPR    = new ST("ST.EXPR"); // EXPRESSION
    public static final ST STMT    = new ST("ST.STMT"); // STATEMENT
